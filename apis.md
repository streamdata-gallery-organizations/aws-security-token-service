---
name: Streadata.io API Gallery - AWS Security Token Service
description: This is a repository of aws security token service APIs, self-contained
  as a Github repository, with HTML and YAML representations of the APIs and their
  surrounding operations.
image: http://template.streamdata.gallery/assets/aws-security-token-service.png
created: "2018-02-24"
modified: "2018-06-25"
url: http://aws-security-token-service.streamdata.gallery/apis.json
